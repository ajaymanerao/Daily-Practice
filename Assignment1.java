...
// Q9. Season Finder Write a program that takes a month number (1–12) and prints the season:
// Winter (Dec–Feb)
// Summer (Mar–May)
// Monsoon (Jun–Sep)
// Autumn (Oct–Nov)
// Use a switch to decide.
...
// Q10. Even/Odd Menu Write a program that asks the user to choose:
// Check if a number is even Check if a number is odd Use switch to perform the chosen operation.


    public static void Program10(int N){
        switch(N%2){
            case 0:
                System.out.println(N+" It is the even number.");
                break;
